...
def search_study_on_site(site_url, search_path, title):
    ...
    try:
        ...
        result_link = soup.find('a', class_='docsum-title')  # Adjusted selector based on site's HTML
...
site = {"site_name": "PubMed", "url": "https://pubmed.ncbi.nlm.nih.gov", "search_path": "/?term="}
